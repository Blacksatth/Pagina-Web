        ...
        {(error || success) && (
          <div
            className={`p-4 mb-6 rounded-lg ${
              error ? "bg-red-500/20 text-red-300 border border-red-500" : "bg-green-500/20 text-green-300 border border-green-500"
            }`}
          >
            {error || success}
          </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center gap-2 mt-4">
                <input
                  type="checkbox"
                  checked={form.onSale}
                  onChange={(e) => setForm({ ...form, onSale: e.target.checked, salePrice: e.target.checked ? form.salePrice : 0 })}
